...
# Create new figure and position
    def new_figure(self):
        self.figure = Figure(3, 0)

# Figure and game field intersection
    def intersects(self):
        intersection = False
        for i in range(4):
            for j in range(4):
...
# Space duplicates Down until reaches bottom
    def go_space(self):
...
# Freeze figure when reached bottom
    def freeze(self):
        for i in range(4):
            for j in range(4):
                if i * 4 + j in self.figure.image():
